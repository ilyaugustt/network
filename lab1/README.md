...
5. В ноду лидера кластера (pg-master) добавляем таблицу и вставляем в неё данные
![создание таблицы](images/img_5.png)
6. Проверяем, что в pg-slave также создалась эта таблица с теми же данными
![image](images/img_6.png)
7. Неудачно пытаемся удалить строчку из таблицы подключения pg-slave
